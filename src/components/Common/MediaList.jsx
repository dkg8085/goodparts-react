...
const MediaItem = ({ media, hideDownload, underline }) => {
  ...
  return (
    <div className="media-list-wrapper">
      ...
      {/* Title – underline controlled by prop */}
      <div
        className="media-des"
      >
        { media?.clip_description || media?.custom_fields?.clip_description || media.title || media.description}
      </div>
...
export default function MediaList({ mediaList, hideDownload, underline }) {
  return (
    <>
      {mediaList && (
        <>
