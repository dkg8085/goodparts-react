...
import { refreshUserData } from "../../redux/thunks/authThunks";
...
export default function Header() {
  ...
  const showRestore = !!(token && previousUser);

  const handleRestore = (e) => {
    e.preventDefault();
    if (!previousUser) return;
    const prevUser = JSON.parse(previousUser);
    dispatch(refreshUserData(prevUser.ID))
      .unwrap()
      .then(() => {
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-50 header-col play-icon-wrap">
              ...
              {showRestore && (
                <button onClick={handleRestore}>Back to previous user</button>
              )}
            </div>
